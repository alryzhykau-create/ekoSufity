...
function CtaIcon({ name }: { name: "phone" | "whatsapp" }) {
  ...
  if (name === "phone") {
    return (
      <svg {...iconProps} className="ctaIconPhone" viewBox="0 0 401.998 401.998" fill="currentColor">
        ...
        <div className="container pricingDeck">
          ...
          <aside className="priceExamplesPanel" aria-labelledby="price-examples-title">
            ...
            <p className="softLabel">
              Realizacje z oświetleniem i dodatkami. Sam sufit liczymy średnio ok. 120 zł/m²
            </p>
            <div className="priceExamplesActions">
