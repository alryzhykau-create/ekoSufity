          ...
          <div className="processCta">
            ...
            >
              <span className="waCtaIcon" aria-hidden="true">
                {/* viewBox przesunięty o pół jednostki — sam glif jest narysowany
                    niesymetrycznie (4.8/4.05 z boków), to go optycznie centruje. */}
                <svg viewBox="0.375 -0.4 32 32" width="26" height="26">
                  <path
                    fill="currentColor"
