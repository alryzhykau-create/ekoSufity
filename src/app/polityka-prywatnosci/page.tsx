          ...
          <article className="card privacyTextCard" style={{ maxWidth: 820, margin: "0 auto" }}>
            ...
            <ul>
              ...
              <li>
                ...
                system operacyjny, przybliżona lokalizacja, strony odwiedzane w serwisie oraz sposób
                korzystania z nich — zbierane automatycznie za pomocą plików cookie i podobnych
                technologii.
              </li>
            </ul>
            ...
            <p>
              Twoich danych nie sprzedajemy ani nie udostępniamy w celach zarobkowych. Dane mogą być
              powierzone lub udostępnione wyłącznie podmiotom, które wspierają działanie serwisu i
              naszą działalność:
            </p>
            <ul>
            ...
            <p>
              ...
              podstawie decyzji o odpowiednim stopniu ochrony (np. Data Privacy Framework). Narzędzia
              te uruchamiamy wyłącznie po wyrażeniu przez Ciebie zgody w banerze cookie.
            </p>
            ...
            <p>
              W ramach działań reklamowych (Google, Meta, TikTok) Twoje dane mogą być wykorzystywane
              do profilowania — czyli automatycznego dopasowywania wyświetlanych reklam do Twoich
              zainteresowań na podstawie aktywności w internecie. Profilowanie to nie wywołuje wobec
              Ciebie skutków prawnych ani nie wpływa istotnie na Twoją sytuację. Odbywa się wyłącznie
              po wyrażeniu zgody na pliki cookie reklamowe i możesz je w każdej chwili wyłączyć,
              wycofując zgodę.
            </p>
            ...
            <ul>
              <li>
                Dane z zapytań przechowujemy przez czas niezbędny do obsługi zapytania i ewentualnej
                realizacji usługi, a następnie przez okres wymagany przepisami (np. podatkowymi) lub
            ...
            <h2>9. Twoje prawa</h2>
            <p>
              Przysługują Ci prawa do: dostępu do swoich danych i uzyskania ich kopii; sprostowania
              (poprawienia) danych; usunięcia danych („prawo do bycia zapomnianym”); ograniczenia
              przetwarzania; przenoszenia danych; wniesienia sprzeciwu wobec przetwarzania opartego
              na prawnie uzasadnionym interesie, w tym wobec profilowania na potrzeby marketingu;
